...
# Pruebas reconocimiento con Rippers
...
2. Abre una terminal y navega al directorio del proyecto, adicional hay que ingresar a la carpeta Rippers. Dado que es la raiz del proyecto.

3. Dentro de la carpeta Rippers se debe ejecutar el siguiente comando: 

   ```bash
   npm install

4. Asegurate de ingresar los datos "EMAIL" y "PASSWORD" correspondientes al usuario administrador de GHOST en el archivo "Rippers/config.json".

## Ejecución de pruebas

Para ejecutar las pruebas, sigue estos pasos:

1. Asegurate que esta corriendo correctamente el aplicativo GHOST en la versión correspondiente en el puerto según lo parametrizado en el archivo Rippers/config.json".

2. Abre una terminal en el directorio "Rippers/"" del proyecto.
...
4. Se comenzarán a ejecutarse las pruebas. 

5. Al finalizar la ejecución, podrás ver los resultados en la terminal, también encontraras evidencia de las ejecuciones en la carpeta "Rippers/results".

## Observaciones

Estas pruebas van a navegar por todos los objetos de la pagina posterior a loguearse en el sistema, las pruebas pueden tomar varios minutos dado que, va a dar clic en todos los elementos encontrados, estas pruebas se van a a ejecutar con el navegador webkit en una ventana de tamaño 500x500.


# Pruebas automatizadas con Kraken

Este proyecto de prueba utiliza Kraken para realizar ejecuciones de 30 escenarios. Las pruebas simulan la navegación y la interacción del usuario con elementos en la página web "http://localhost:XXXX/ghost/". Se ejecutan pruebas en las versiones v4.44.0 y v5.68.0 de GHOST, adicionalmente se realiza la ejecucón de Resemble.js y BackstopJS para las pruebas de regresión visual comparando los resultados obtenidos en cada una de las versiones de GHOTS mencionadas
...
6. Asegurate de que en la carpeta "GHOST_4_44_0/Kraken/reports" solo se encuentren las carpetas con los siguientes nombre:
    ...
    "Change_password_1_character","Change_password_9_character","Change_password_10_character","Change_password_ok","Change_profile_empty_required_fields","Change_profile_exceeding_the_limit_of_required_fields","Change_profile_required_fields","Delete_Page", "Delete_Post", "Delete_Tag", "Delete_Member", "Edit_name_blog", "Edit_Page","Edit_Post","Edit_Tag","Login","New_member","New_Page","New_Post","New_Tag","Unpublish_Page","Unpublish_post", "Many_logins_and_one_successful","New_member_exceeding_field_limit","New_member_to_field_limit"
